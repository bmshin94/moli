...
impl NetworkFetchFailureContext {
    ...
    pub fn with_redirect_history(
        ...
        let current = failure.request_context.get_or_insert_with(|| {
        ...
        redirects.append(&mut current.redirect_chain);
        current.redirect_chain = redirects;
